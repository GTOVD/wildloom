...
- **Instances are procedurally unique:** stats, materials, genes, training emphasis, composed affinity weights, and learned abilities vary per creature; battles assemble from **procedural biome/field** seeds ([`TECHNICAL-DESIGN.md`](./TECHNICAL-DESIGN.md) §1, [`GAMEPLAY-SYSTEMS.md`](./GAMEPLAY-SYSTEMS.md) §1.1).
