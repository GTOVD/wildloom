...
- **Composable attacks (templates only):** [`docs/ATTACK-CATALOG.md`](docs/ATTACK-CATALOG.md) · [`data/moves/attack_templates.catalog.json`](data/moves/attack_templates.catalog.json)
- **Resolved move fixtures (Blast ×4 sample):** [`data/moves/examples/resolved_blast_variants.sample.yaml`](data/moves/examples/resolved_blast_variants.sample.yaml)
